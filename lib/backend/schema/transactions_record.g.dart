...
class _$TransactionsRecordSerializer
  ...
  Iterable<Object?> serialize(
    ...
    value = object.usersTransaction;
    if (value != null) {
      result
        ..add('Users_Transaction')
        ..add(serializers.serialize(value,
      ...
      switch (key) {
        ...
        case 'vendor_name':
          result.vendorName = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
        case 'Users_Transaction':
          result.usersTransaction = serializers.deserialize(value,
...
class _$TransactionsRecord extends TransactionsRecord {
  ...
  @override
  final DocumentReference<Object?>? usersTransaction;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is TransactionsRecord &&
        ...
        usersTransaction == other.usersTransaction &&
        ffRef == other.ffRef;
  }
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, usersTransaction.hashCode);
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'TransactionsRecord')
          ...
          ..add('usersTransaction', usersTransaction)
          ..add('ffRef', ffRef))
        .toString();
  }
}
...
class TransactionsRecordBuilder
  ...
  DocumentReference<Object?>? _usersTransaction;
  DocumentReference<Object?>? get usersTransaction => _$this._usersTransaction;
  set usersTransaction(DocumentReference<Object?>? usersTransaction) =>
      _$this._usersTransaction = usersTransaction;
  ...
  TransactionsRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _usersTransaction = $v.usersTransaction;
      _ffRef = $v.ffRef;
      _$v = null;
    }
    return this;
  ...
  _$TransactionsRecord _build() {
    final _$result = _$v ??
        new _$TransactionsRecord._(
            ...
            usersTransaction: usersTransaction,
            ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
