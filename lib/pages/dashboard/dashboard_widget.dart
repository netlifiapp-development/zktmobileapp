            ...
            children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      await launchURL('https://lobstr.co/');
                                    },
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
                                      mainAxisAlignment:
                                            ...
                                            valueOrDefault<String>(
                                              valueOrDefault(
                                                  currentUserDocument
                                                      ?.zKTWalletAddress,
                                                  ''),
                                              'Get ZKT by adding Lobstr wallet',
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 12.0, 4.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      SvgPicture.asset(
                                        'assets/images/business-management-and-administration.svg',
                                        width: 40.0,
                                        height: 40.0,
                                        fit: BoxFit.cover,
                                      ),
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(4.0, 12.0, 4.0, 0.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: PagedListView<DocumentSnapshot<Object?>?, UserRecord>(
                    pagingController: () {
                      final Query<Object?> Function(Query<Object?>)
                          queryBuilder = (userRecord) => userRecord
                              .orderBy('created_time', descending: true);
                      if (_model.pagingController != null) {
                        final query = queryBuilder(UserRecord.collection);
                      ...
                      _model.pagingQuery = queryBuilder(UserRecord.collection);
                      _model.pagingController!
